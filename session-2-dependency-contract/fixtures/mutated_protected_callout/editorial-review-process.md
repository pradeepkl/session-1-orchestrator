...
### 10. Chapter-number references leaking into manuscript prose
The style guide already prohibits "Chapter 4 shows..." in body prose. This
recurs most often in the closing bridge sentence to the next chapter. Fix
...
- The Summary's closing wrap-up paragraph (only the closing bridge gets
  rewritten, not the wrap-up itself)

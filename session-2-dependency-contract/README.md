...
CheckResult(assumption_id='checklist_question_count', passed=True, expected=7, found=7, detail='editorial-review-process-addendum-go-no-go.md declares 7 checklist questions and lists 7 numbered questions.')
...
CheckResult(assumption_id='hard_constraint_count', passed=True, expected=5, found=5, detail='agent-judgment-playbook.md Hard Constraints section should list 5 named constraints and currently matches 5 required constraint titles.')
CheckResult(assumption_id='protected_callout_names_present', passed=True, expected=['recap', 'opening', 'not the right choice', 'decision rule'], found=['recap', 'opening', 'not the right choice', 'decision rule'], detail="Protected callout keywords present in editorial-review-process.md 'What NOT to Touch by Default'; missing: none.")
CheckResult(assumption_id='recommendation_scale_consistency', passed=True, expected=[...], found={...}, detail='Recommendation scale tokens in the addendum and playbook normalize to the editorial-review-process.md scale; mismatches: none.')
